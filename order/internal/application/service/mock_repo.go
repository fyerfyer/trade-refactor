...
// Get provides a mock function with given fields: ctx, orderID, status
func (_m *Repository) Get(ctx context.Context, orderID uint64, status string) (*domain.Order, error) {
	...
	var r0 *domain.Order
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, string) (*domain.Order, error)); ok {
		return rf(ctx, orderID, status)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64, string) *domain.Order); ok {
...
//   - orderID uint64
//   - status string
func (_e *Repository_Expecter) Get(ctx interface{}, orderID interface{}, status interface{}) *Repository_Get_Call {
	return &Repository_Get_Call{Call: _e.mock.On("Get", ctx, orderID, status)}
}

func (_c *Repository_Get_Call) Run(run func(ctx context.Context, orderID uint64, status string)) *Repository_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Repository_Get_Call) RunAndReturn(run func(context.Context, uint64, string) (*domain.Order, error)) *Repository_Get_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Repository) GetUnpaidOrder(ctx context.Context, orderID uint64) (*domain.Order, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetUnpaidOrder")
	}
